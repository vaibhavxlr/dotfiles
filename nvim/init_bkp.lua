...
require('lazy').setup {
  ...
  -- Autopairs (auto-close braces, quotes, etc.)
  {
...
-- Mappings that use Telescope for a nicer UI
lsp_keys('n', 'gd', function()
  require('telescope.builtin').lsp_definitions()
end, { desc = 'Telescope go to definition' })
lsp_keys('n', 'gD', function()
  require('telescope.builtin').lsp_declarations()
end, { desc = 'Telescope go to declaration' })
lsp_keys('n', 'gi', function()
  require('telescope.builtin').lsp_implementations()
end, { desc = 'Telescope go to implementation' })
lsp_keys('n', 'gr', function()
  require('telescope.builtin').lsp_references()
end, { desc = 'Telescope go to references' })

-- Symbol searching
lsp_keys('n', '<leader>s', function()
  require('telescope.builtin').lsp_dynamic_workspace_symbols()
end, { desc = 'Workspace Symbols' })

-- Other useful LSP keymaps
-- lsp_keys("n", "<leader>ca", vim.lsp.buf.code_action, { desc = "Code Action" })
-- lsp_keys("n", "<leader>rn", vim.lsp.buf.rename, { desc = "Rename" })
-- lsp_keys("n", "<leader>D", vim.lsp.buf.type_definition, { desc = "Type Definition" })
lsp_keys('n', '<leader>p', vim.lsp.buf.hover, { desc = 'Hover Info' })
lsp_keys('n', '<leader>d', vim.diagnostic.open_float, { desc = 'Open floating diagnostic' })
